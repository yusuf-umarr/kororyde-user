...
import 'package:kororyde_user/common/app_images.dart';
import 'package:kororyde_user/core/utils/custom_loader.dart';
...
import 'package:kororyde_user/features/bookingpage/domain/models/chat_history_model.dart';
import 'package:kororyde_user/l10n/app_localizations.dart';



class ChatWithCoSharer extends StatelessWidget {
  static const String routeName = '/chatWithCosharer';

  const ChatWithCoSharer({super.key});
  @override
