...
class BuyMobileData extends StatefulWidget {
  const BuyMobileData({super.key});

  @override
  State<BuyMobileData> createState() => _BuyMobileDataState();
}

class _BuyMobileDataState extends State<BuyMobileData> {
  ...
  bool isOpen = false;
  bool isOpenTwo = false;

  List<String> networkType = ['MTN', 'GLO', '9MOBILE', 'AIRTEL'];
          ...
          children: [
            Column(
              ...
              children: [
                ...
                // Button(
                //   text: 'Wallet Balance (${getCurrency()}1,000)',
                //   onPressed: () async {},
                //   hasIcon: false,
                //   color: AppColors.blue,
