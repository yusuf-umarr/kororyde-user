...
class _BuyElectricityState extends State<BuyElectricity> {
  ...
  List<String> networkType = ['IBDC', 'IBDC', 'IBDC', 'IBDC'];
                  ...
                  children: [
                    ...
                    if (isOpen)
                      Card(
                        ...
                        child: Column(
                            children:
                                List.generate(networkType.length, (int index) {
                          return ListTile(
                            onTap: () {
                              _networkController.text = networkType[index];
                              setState(() {
                                isOpen = false;
                              });
                            },
